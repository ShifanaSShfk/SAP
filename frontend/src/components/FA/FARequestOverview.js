        ...
        <div className="content-area">
          ...
          <div className="request-details">
            ...
            <div className="detail-row">
              ...
              <div className="detail-value file-link">certificate.pdf</div>
            </div>
          </div>

          <div className="action-buttons">
            <button className="approve-btn"><Link to="/fa-approved">Approve</Link> </button>
            <button className="reject-btn"><Link to="/fa-rejected">Reject</Link> </button>
          </div>
        </div>
      </div>
    </div>
